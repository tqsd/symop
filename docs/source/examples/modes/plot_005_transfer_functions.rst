...
.. "examples/modes/plot_005_transfer_functions.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_modes_plot_005_transfer_functions.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_modes_plot_005_transfer_functions.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    === overlaps <in|out> ===
    Gaussian low-pass                         (0.8137334712067347+0j)   |ov|=0.813733
    Gaussian high-pass                        (0.18626652879326497+0j)   |ov|=0.186267
    Gaussian band-pass                        (0.5734623443633281+0j)   |ov|=0.573462
    Rectangular band-pass                     (0.5162215046731081+0j)   |ov|=0.516222
    Super-Gaussian band-pass                  (0.5253197404079591+0j)   |ov|=0.52532
    Constant phase                            (0.764842187284488-0.6442176872376908j)   |ov|=1
    Time delay                                (-0.8264201259387586-0.30956511191471614j)   |ov|=0.882497
    Quadratic dispersion                      (0.9901942718304997+0.08030059034495145j)   |ov|=0.993445
    Product: band-pass * delay                (-0.5153946329474486-0.19305942851692384j)   |ov|=0.550367
    Cascade: low-pass -> delay -> dispersion -> phase  (-0.7149910030464851+0.21850596121512733j)   |ov|=0.747634
...
.. image-sg:: /examples/modes/images/sphx_glr_plot_005_transfer_functions_001.png
   :alt: Time-domain amplitude: $|\zeta_{\mathrm{out}}(t)|$ for various $H(\omega)$
   :srcset: /examples/modes/images/sphx_glr_plot_005_transfer_functions_001.png
...
.. image-sg:: /examples/modes/images/sphx_glr_plot_005_transfer_functions_002.png
   ...
   :srcset: /examples/modes/images/sphx_glr_plot_005_transfer_functions_002.png
   :class: sphx-glr-single-img
...
.. _sphx_glr_download_examples_modes_plot_005_transfer_functions.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_005_transfer_functions.ipynb <plot_005_transfer_functions.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_005_transfer_functions.py <plot_005_transfer_functions.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_005_transfer_functions.zip <plot_005_transfer_functions.zip>`
