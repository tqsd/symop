...
class GaussianLowpass(GaussianClosedTransferBase):
    r"""Gaussian low-pass amplitude transfer.
...
if TYPE_CHECKING:
    ...
    _check_gaussian_lowpass: TransferFunction = GaussianLowpass(
        w0=1.0,
        sigma_w=2.0,
    )
