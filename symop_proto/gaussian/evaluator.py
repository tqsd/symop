...
class GaussianEvaluator:
    ...
    def _centered_contraction(
        self, op1: LadderOpProto, op2: LadderOpProto
    ) -> complex:
        r"""
    ...
    def _ops_key(
        self, ops: Sequence[LadderOpProto]
    ...
    def _expect_ops(self, ops: Sequence[LadderOpProto]) -> complex:
        ...
        def rec(seq: Sequence[LadderOpProto]) -> complex:
            ...
            for t, op_t in enumerate(rest):
                c = self._centered_contraction_fast(
                    first, op_t, N0=N0, M0=M0, G=G
                )
    ...
    def expect_monomials(
        self, monomials: Sequence[MonomialProto]
    ) -> np.ndarray:
        r"""
